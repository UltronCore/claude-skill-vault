...
## Logging Significant PR Decisions to Obsidian
For architectural or high-impact PRs, log the review findings to your Obsidian decision log:
- Open `~/obsidian-vault/Projects/<project-name>.md`
- Add a dated entry under a "## PR Reviews" or "## Decisions" section
- Link to the PR URL and summarize the GitNexus impact analysis

See `obsidian-automation` for Obsidian MCP write workflows.

## Related Skills
- `gitnexus-impact-analysis` — blast radius of PR changes
- `gitnexus-exploring` — deep exploration of changed modules
- `gitnexus-guide` — full tool reference
- `github-actions-advanced` — CI status and checks on the PR
- `obsidian-automation` — log decisions to vault

## GitNexus Index
This skill is indexed by GitNexus for knowledge graph traversal.
Index path: /Users/localuser/.claude/skills/gitnexus-pr-review/.gitnexus
