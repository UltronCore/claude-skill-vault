...
## Related Skills
- `a11y-wcag` — WCAG compliance guidelines
- `github-actions-ci-workflow` — CI/CD integration
- `semgrep-rule-creator` — static analysis rules

## GitNexus Index
This skill is indexed by GitNexus for knowledge graph traversal.
Index path: /Users/localuser/.claude/skills/a11y-checker-ci/.gitnexus
