...
## Related Skills
- `adaptive-private-memory-engine` — core memory engine
- `autonomous-knowledge-system` — knowledge graph memory
- `obsidian-automation` — external memory in Obsidian

## GitNexus Index
This skill is indexed by GitNexus for knowledge graph traversal.
Index path: /Users/localuser/.claude/skills/adaptive-private-memory-engine-misc/.gitnexus
