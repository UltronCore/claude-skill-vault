...
### assets/.env.example
Template showing all required environment variables. Use as a reference for setting up new environments or auditing existing ones.
...
```bash
# Database
DATABASE_URL="postgresql://user:password@staging-db.com:5432/app_staging"
...
```bash
# Database
DATABASE_URL="postgresql://user:password@prod-db.com:5432/app_prod"
