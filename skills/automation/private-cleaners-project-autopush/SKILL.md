---
name: private-cleaners-project-autopush
description: Auto-commit and push the Example Cleaners Site site to GitHub, both on demand and proactively.
---
...
## Related Skills
- `auto-push` — general auto-push patterns
- `cloudflare-pages-autopush` — Cloudflare deployment
- `git-guardrails-claude-code` — safe git practices

## GitNexus Index
This skill is indexed by GitNexus for knowledge graph traversal.
Index path: /Users/localuser/.claude/skills/private-cleaners-project-autopush/.gitnexus
