...
## Related Skills
- `openapi-first-development` — design-first API workflow
- `api-contracts-and-zod-validation` — contract validation
- `api-security-hardening` — API security

## GitNexus Index
This skill is indexed by GitNexus for knowledge graph traversal.
Index path: /Users/localuser/.claude/skills/api-design-reviewer/.gitnexus
