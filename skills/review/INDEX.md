...
|-------|-------------|---------|--------|
| [improve-codebase-architecture](improve-codebase-architecture/) | TODO: add description | v1 | ✅ active |
| [Public Release Review](public-release-review/) | Runs a pre-publication quality gate on any skill headed to the public repository. Checks for private data, documentation completeness, version consistency, changelog accuracy, and generates concise public update notes when meaningful changes have been made. | v1 | ✅ active |
...
| [triage-issue](triage-issue/) | TODO: add description | v1 | ✅ active |
